async function main() {
    ...
    this.FineCore = await ethers.getContractFactory("FineCoreFlat");
    this.FineShop = await ethers.getContractFactory("FineShopFlat");
    this.Solids = await ethers.getContractFactory("SolidsFlat");
